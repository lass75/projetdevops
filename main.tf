provider "aws" {
    region = "us-east-1"
    access_key = "AKIA6GBMCRYKDTM34H5E"
    secret_key = "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"
 }
...
resource "aws_instance" "Jenkins" {
  ...
  vpc_security_group_ids = [aws_security_group.cicdSecGrp.id]
...
resource "aws_security_group" "cicdSecGrp" {
  name        = "cicdSecGrp"
...
output "instance_public_ip_Prometheus_Grafana" {
